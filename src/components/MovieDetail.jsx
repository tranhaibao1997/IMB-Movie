                            ...
                            >

                              {
                                favorite[0].find(elm => elm === movieDetails.id)
                                  ? <i onClick={() => removeFromFavorite(movieDetails.id)} className="fas fa-heart" /> : <i onClick={() => addToFavorite(movieDetails.id)} className="fas fa-heart black" />
                              }
                            </button>
